...
highlight: pygments
---
In a prior post [TODO: LINK TO POST](here) we discussed implementing the Kolmogorov-Smirnov test in Spark. In this follow-on post, we’ll visit an alternative goodness-of-fit test: Anderson-Darling test.
